...
<head>
    ...
    <title>Kelola Kategori - KOMINFO</title>
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-danger" data-toggle="modal" data-target="#editModal-{{$Category->id}}">Edit</button></a>
                                                </td>
                                            </tr>
                                            @endforeach
                ...
                <div class="modal-body">
                    <form action="/kategori" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text-area" class="form-control" required>
                        </div>
                </div>
