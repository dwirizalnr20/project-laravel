...
<head>
    ...
    <title>Kelola Aset Software - KOMINFO</title>
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$aset->pemegang}}</td>
                                                <td></td>
                                                <form method="POST" action="/softwareadm {{ $aset->id}}">
                                                    @method('delete')
                                                    @csrf
                                                    <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/softwareadm" method="post" enctype="multipart/form-data">
                        @csrf
    ...
    <div id="editModal-{{$data->id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/aset {{$data->id}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Nama Aset</label>
